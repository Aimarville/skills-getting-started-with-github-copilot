...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice team drills and play against other schools",
    ...
    "Swimming Club": {
        ...
        "max_participants": 25,
        "participants": ["linda@mergington.edu", "tyler@mergington.edu"]
    },
    "Art Club": {
    ...
    "Drama Club": {
        ...
        "max_participants": 20,
        "participants": ["bella@mergington.edu", "ethan@mergington.edu"]
    },
    "Science Bowl": {
        "description": "Compete in academic quiz competitions focused on science",
